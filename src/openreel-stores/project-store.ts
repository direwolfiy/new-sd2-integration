...
import { getEffectsBridge } from "../openreel-bridges/effects-bridge";
import { getTransitionBridge } from "../openreel-bridges/transition-bridge";
import {
  autoSaveManager,
  initializeAutoSave,
  type AutoSaveMetadata,
} from "../openreel-services/auto-save";
import { useEngineStore } from "./engine-store";
import { getMediaBridge, initializeMediaBridge } from "../openreel-bridges/media-bridge";
import {
  createEmptyProject,
...
import {
  ...
  loadFileHandle,
  loadDirectoryHandle,
} from "../openreel-services/media-storage";
import { restoreMediaItem } from "../openreel-utils/media-recovery";
import { projectManager } from "../openreel-services/project-manager";
