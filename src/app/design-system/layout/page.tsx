    ...
    <div className="px-6 py-16 max-w-6xl mx-auto space-y-20">
      ...
      <section className="space-y-6">
        ...
        <div className="space-y-3">
          {[
            ...
            <div
              key={item.level}
              className={`flex items-center gap-6 rounded-lg p-4 ${item.ring ? "border border-[rgba(255,255,255,0.06)]" : "border border-white/5"}`}
              style={{ backgroundColor: item.bg }}
            >
              <div className="w-48 shrink-0">
                <p className="text-sm font-medium">{item.level}</p>
                <p className="text-[13px] text-[#999999] mt-0.5">{item.desc}</p>
              </div>
      ...
      <section className="space-y-6">
        ...
        <div className="rounded-xl border border-[rgba(255,255,255,0.06)] bg-[#141414] overflow-hidden">
          {/* Top bar */}
          <div className="h-10 bg-[#0a0a0a] border-b border-white/5 flex items-center px-4 gap-3">
            <div className="w-5 h-5 rounded bg-[#00CAE0]" />
            <span className="text-xs text-white font-medium">SD2</span>
            <div className="flex-1" />
            <div className="flex items-center gap-3">
              <div className="h-7 px-3 rounded-md bg-[#262626] flex items-center text-[11px] text-[#666]">
          ...
          <div className="flex min-h-[260px]">
            {/* Sidebar */}
            <div className="w-44 shrink-0 bg-[#0a0a0a] border-r border-white/5 py-3 px-2 flex flex-col">
              <div className="px-3 py-2 rounded-md text-[13px] flex items-center gap-2.5 bg-white/[0.06] text-white">
              ...
              <div className="px-3 py-2 rounded-md text-[13px] flex items-center gap-2.5 text-[#999] hover:text-white hover:bg-white/[0.03]">
            ...
            <div className="flex-1 p-6">
              <div className="grid grid-cols-3 gap-3">
                {[1, 2, 3, 4, 5, 6].map((n) => (
                  <div key={n} className="rounded-lg border border-white/5 bg-[#1c1c1c] h-24" />
                ))}
              </div>
              <p className="text-[12px] text-[#666] mt-3 text-center">项目列表内容区</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="space-y-6">
        ...
        <div className="rounded-xl border border-[rgba(255,255,255,0.06)] bg-[#141414] overflow-hidden">
          ...
          <div className="h-10 bg-[#0a0a0a] border-b border-white/5 flex items-center px-4 gap-0">
            ...
            <div className="flex items-center gap-0.5 px-2">
              {[
                ...
                >
                  {item.name}
                  {item.name === "分集管理" && (
                    <span className="ml-1.5 text-[11px] text-[#666] bg-white/[0.06] px-1.5 py-0.5 rounded">{6}</span>
                  )}
                </div>
              ))}
              <div className="w-px h-4 bg-white/[0.06] mx-1.5" />
              <div className="px-2.5 h-7 flex items-center gap-1.5 text-[13px] text-[#999] hover:text-white rounded-md hover:bg-white/[0.04] cursor-pointer transition-colors">
            ...
            <div className="flex-1" />
            <div className="flex gap-3 text-[13px] text-[#666]">
          ...
          <div className="min-h-[240px] p-6 flex items-center justify-center">
            <p className="text-sm text-[#999999]">工作区内容 — 总剧本编辑器 / 元素库</p>
          </div>
        </div>
      </section>
        ...
        <div className="rounded-xl border border-[rgba(255,255,255,0.06)] bg-[#141414] overflow-hidden">
          ...
          <div className="h-10 bg-[#0a0a0a] border-b border-white/5 flex items-center px-4 gap-0">
            <div className="flex items-center gap-2 pr-3 border-r border-white/[0.06]">
              ...
              <span className="text-[13px] text-[#999]">星辰变</span>
            </div>
            ...
            <div className="flex-1 flex flex-col">
              <div className="flex-1 p-6 flex items-center justify-center">
                <div className="text-center space-y-3">
                  <div className="w-16 h-10 mx-auto rounded bg-[#262626] border border-white/5" />
                  <p className="text-sm text-[#999999]">主工作区 — 分镜卡片列表 / 视频预览</p>
                </div>
              </div>
              {/* Bottom Timeline Bar */}
              <div className="h-12 bg-[#0a0a0a] border-t border-white/5 flex items-center px-4 gap-3">
                <div className="flex gap-1">
                  {[20, 40, 30, 50, 25, 35, 45, 28].map((w, i) => (
                    <div
                      key={i}
                      className={`h-7 rounded-sm ${i < 3 ? "bg-[#00CAE0]/30" : "bg-[#262626]"}`}
                      style={{ width: `${w}px` }}
                    />
                  ))}
                </div>
                <span className="text-[11px] text-[#999999] ml-auto">00:32 / 02:15</span>
              </div>
            </div>
            {/* Right Properties Panel */}
            <div className="w-52 shrink-0 bg-[#0a0a0a] border-l border-white/5 p-4">
              <p className="text-[13px] font-medium mb-3">属性面板</p>
              <div className="space-y-3">
                <div>
                  <p className="text-[11px] text-[#999999] mb-1">镜头描述</p>
                  <div className="h-8 rounded bg-[#262626] border border-white/5" />
                </div>
                <div>
                  <p className="text-[11px] text-[#999999] mb-1">时长</p>
                  <div className="h-8 rounded bg-[#262626] border border-white/5" />
                </div>
                <div>
                  <p className="text-[11px] text-[#999999] mb-1">引用元素</p>
                  <div className="flex gap-1">
