  ...
  return (
    <div className="px-6 py-16 max-w-6xl mx-auto space-y-20">
      ...
      <div>
        ...
        <p className="text-[15px] text-[#999] leading-[1.8] max-w-2xl">
      ...
      {/* Accent Picker */}
      <div className="rounded-xl border border-white/5 bg-[#141414] p-5 space-y-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <input
              ...
              className="h-8 w-24 px-3 rounded-lg bg-[#262626] border border-white/10 text-white text-[13px] font-mono placeholder:text-white/20 focus:outline-none focus:border-white/30"
              placeholder="#000000"
            />
            <button
            ...
            <button
              ...
              className={`flex items-center gap-2 px-3 py-1.5 rounded-full text-[13px] border transition-all duration-200 ${
                accentHex === p.hex
                  ...
                  : "border-white/5 text-[#666] hover:border-white/10 hover:text-[#999]"
              }`}
            >
      ...
      <section className="space-y-4">
        ...
        <div className="rounded-xl border border-white/5 bg-[#141414] p-6 space-y-6">
          <div>
            <p className="text-[11px] text-[#666] mb-3 uppercase tracking-wider">Neutrals — 90%</p>
            <div className="flex flex-wrap gap-2">
              {neutrals.map((n) => (
                <div key={n.color} className="flex flex-col items-center gap-1.5">
                  ...
                  <span className="text-[10px] text-[#666]">{n.label}</span>
                  <span className="text-[9px] text-[#444] font-mono">{n.color}</span>
                </div>
              ))}
            </div>
          </div>
          <div>
            <p className="text-[11px] text-[#666] mb-3 uppercase tracking-wider">Accent — 10%</p>
            <div className="flex gap-2">
              <div className="flex flex-col items-center gap-1.5">
                <div className="w-14 h-14 rounded-lg" style={{ backgroundColor: accent.color }} />
                <span className="text-[10px] text-[#666]">主色</span>
                <span className="text-[9px] text-[#444] font-mono">{accent.color}</span>
              </div>
              <div className="flex flex-col items-center gap-1.5">
                <div className="w-14 h-14 rounded-lg border border-white/10" style={{ backgroundColor: accent.bg }} />
                <span className="text-[10px] text-[#666]">浅底 8%</span>
                <span className="text-[9px] text-[#444] font-mono">0.08a</span>
              </div>
              <div className="flex flex-col items-center gap-1.5">
                <div className="w-14 h-14 rounded-lg border border-white/10" style={{ backgroundColor: accent.border }} />
                <span className="text-[10px] text-[#666]">边框 15%</span>
                <span className="text-[9px] text-[#444] font-mono">0.15a</span>
              </div>
              <div className="flex flex-col items-center gap-1.5">
                <div className="w-14 h-14 rounded-lg border border-white/10" style={{ backgroundColor: accent.text }} />
                <span className="text-[10px] text-[#666]">文字 80%</span>
                <span className="text-[9px] text-[#444] font-mono">0.8a</span>
              </div>
            </div>
          </div>
          <div>
            <p className="text-[11px] text-[#666] mb-3 uppercase tracking-wider">Danger — 独立于强调色</p>
            <div className="flex gap-2">
              <div className="flex flex-col items-center gap-1.5">
                <div className="w-14 h-14 rounded-lg bg-[#ef4444]" />
                <span className="text-[10px] text-[#666]">危险</span>
                <span className="text-[9px] text-[#444] font-mono">#ef4444</span>
              </div>
              <div className="flex flex-col items-center gap-1.5">
                <div className="w-14 h-14 rounded-lg border border-white/10 bg-[rgba(239,68,68,0.1)]" />
                <span className="text-[10px] text-[#666]">危险底</span>
                <span className="text-[9px] text-[#444] font-mono">0.1a</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="rounded-xl border border-white/5 bg-[#141414] p-5 space-y-3">
            ...
            <ul className="space-y-2 text-[13px] text-[#999]">
      ...
      <section className="space-y-4">
        ...
        <div className="rounded-xl border border-white/5 bg-[#141414] p-6 space-y-6">
          <div>
            <p className="text-[11px] text-[#666] mb-3 uppercase tracking-wider">Primary — 页面唯一主操作</p>
          ...
          <div>
            <p className="text-[11px] text-[#666] mb-3 uppercase tracking-wider">Secondary — 次要但相关的操作</p>
            <div className="flex flex-wrap items-center gap-3">
              <button
          ...
          <div>
            <p className="text-[11px] text-[#666] mb-3 uppercase tracking-wider">Tertiary — 取消、返回等低权重</p>
            <div className="flex flex-wrap items-center gap-3">
          ...
          <div>
            <p className="text-[11px] text-[#666] mb-3 uppercase tracking-wider">Ghost — 链接、了解更多</p>
            <div className="flex flex-wrap items-center gap-3">
              <button className="h-10 px-6 rounded-full text-[13px] active:scale-[0.97] transition-all duration-100" style={{ color: accent.text }}>
                了解更多 →
              </button>
              <button className="h-10 px-6 rounded-full text-[#666] text-[13px] hover:text-[#999] active:scale-[0.97] transition-all duration-100">
                重置
              </button>
            </div>
          </div>
          <div>
            <p className="text-[11px] text-[#666] mb-3 uppercase tracking-wider">Danger — 不可逆操作（独立红色）</p>
            <div className="flex flex-wrap items-center gap-3">
          ...
          <div>
            <p className="text-[11px] text-[#666] mb-3 uppercase tracking-wider">Loading — 主/次按钮的加载态</p>
            <div className="flex flex-wrap items-center gap-3">
          ...
          <div>
            <p className="text-[11px] text-[#666] mb-3 uppercase tracking-wider">Disabled</p>
            <div className="flex flex-wrap items-center gap-3">
              <button disabled className="h-10 px-6 rounded-full bg-white/15 text-white/30 text-[13px] font-medium cursor-not-allowed">
                创建项目
              </button>
              <button disabled className="h-10 px-6 rounded-full text-white/30 text-[13px] border border-white/5 cursor-not-allowed">
                生成视频
              </button>
            </div>
          </div>
      ...
      <section className="space-y-4">
        ...
        <p className="text-[14px] text-[#666] leading-[1.7]">去掉了 B 端 SaaS 的彩色体系。只有「进行中」用强调色，其余全部灰白。</p>
        <div className="rounded-xl border border-white/5 bg-[#141414] p-6">
          <div className="space-y-4">
            <div>
              <p className="text-[11px] text-[#666] mb-2 uppercase tracking-wider">项目状态</p>
              <div className="flex flex-wrap gap-3">
                ...
                <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[13px] border border-white/10 text-white bg-white/5">
                  已完结
                </span>
                <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[13px] border border-white/10 text-[#666] bg-white/5">
                  已归档
                </span>
              </div>
            </div>
            <div>
              <p className="text-[11px] text-[#666] mb-2 uppercase tracking-wider">AI 任务状态</p>
              <div className="flex flex-wrap gap-3">
                <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[13px] border border-white/10 text-[#666] bg-white/5">
                  排队中
                </span>
                ...
                <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[13px] border border-white/5 text-white/30 bg-white/[0.02]">
                  已取消
                </span>
              </div>
            </div>
      ...
      <section className="space-y-4">
        ...
        <p className="text-[14px] text-[#666] leading-[1.7]">已完成 = 白色，进行中 = 强调色，未开始 = 灰色。只有两种颜色，干净。</p>
        <div className="rounded-xl border border-white/5 bg-[#141414] p-6 space-y-5 max-w-lg">
          <div className="space-y-2">
            {[
              ...
              <div key={item.label} className="flex items-center gap-3">
                <span className="text-[13px] text-[#999] w-10">{item.label}</span>
                ...
                <span className="text-[12px] text-[#666] w-10 text-right">{item.percent}%</span>
              </div>
            ))}
          </div>

          <div className="border-t border-white/5 pt-5">
            <p className="text-[11px] text-[#666] mb-3 uppercase tracking-wider">任务进度卡片（简化版）</p>
            <div className="rounded-lg border border-white/5 bg-[#0a0a0a] p-4 space-y-3">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <span className="w-1.5 h-1.5 rounded-full animate-pulse" style={{ backgroundColor: accent.color }} />
                  <span className="text-sm font-medium">生成分镜 — 第2集</span>
                </div>
                <span className="text-[13px] text-[#666]">3/5</span>
              </div>
              <div className="h-0.5 rounded-full bg-white/5">
                <div className="h-full rounded-full" style={{ width: "60%", backgroundColor: accent.color }} />
              </div>
              <p className="text-[12px] text-[#666]">预计剩余 2 分 30 秒</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="space-y-4">
        ...
        <div className="rounded-xl border border-white/5 bg-[#141414] p-6 space-y-6">
          <div className="flex items-center gap-4">
            ...
            <div className="h-10 px-4 rounded-lg bg-[#262626] border text-[13px] text-white flex items-center" style={{ borderColor: accent.color, boxShadow: `0 0 0 1px ${accent.color}` }}>
              输入框 focus
            </div>
          </div>
          <div>
            <p className="text-[11px] text-[#666] mb-2 uppercase tracking-wider">Tab — 激活态用白字 + 微底</p>
          ...
          <div>
            <p className="text-[11px] text-[#666] mb-2 uppercase tracking-wider">左侧导航 — 激活态用白字 + 微底</p>
            <div className="w-48 bg-[#0a0a0a] rounded-lg border border-white/5 p-2 space-y-0.5">
