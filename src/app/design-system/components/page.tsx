  ...
  return (
    <div className="px-6 py-16 max-w-6xl mx-auto space-y-20">
      ...
      <section className="space-y-6">
          ...
          <table className="w-full text-[13px]">
            <thead>
              <tr className="border-b border-white/10 text-left bg-[#0a0a0a]">
                <th className="px-5 py-3 font-medium text-[#b8b8b8] w-24">状态</th>
                <th className="px-5 py-3 font-medium text-[#b8b8b8]">处理方式</th>
                <th className="px-5 py-3 font-medium text-[#b8b8b8] w-56">示例</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-white/5">
              <tr>
                <td className="px-5 py-3 text-white font-medium">Default</td>
                <td className="px-5 py-3 text-[#b8b8b8]">基础样式，无额外修饰</td>
              ...
              <tr className="bg-[#0a0a0a]/40">
                ...
                <td className="px-5 py-3 text-[#b8b8b8]">背景提亮（+10%）、文字变白、卡片蓝色光环增强</td>
                <td className="px-5 py-3">
              ...
              <tr className="bg-[#0a0a0a]/40">
                ...
                <td className="px-5 py-3 text-[#b8b8b8]">文字替换为 spinner + 状态文案，<code className="text-[#00CAE0]">pointer-events-none</code></td>
                <td className="px-5 py-3">
        ...
        <div className="rounded-xl border border-[rgba(255,255,255,0.06)] bg-[#181818] p-6 space-y-6">
          <p className="text-[13px] text-[#b8b8b8]">不同元素的完整状态演示 — 交互试试</p>

          {/* Button States */}
          <div>
            <p className="text-[12px] text-[#b8b8b8] mb-3 uppercase tracking-wider">按钮状态</p>
          ...
          {/* Input States */}
          <div>
            <p className="text-[12px] text-[#b8b8b8] mb-3 uppercase tracking-wider">输入框状态</p>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              <div className="space-y-1.5">
                <p className="text-[11px] text-[#b8b8b8]">Default</p>
                <input
                  type="text"
                  placeholder="请输入..."
                  className="w-full h-9 px-3 rounded-lg bg-[#2b2b2b] border border-white/10 text-white text-[13px] placeholder:text-white/30 transition-colors"
                />
              </div>
              <div className="space-y-1.5">
                <p className="text-[11px] text-[#b8b8b8]">Focus</p>
                <input
                  type="text"
                  value="聚焦状态"
                  readOnly
                  className="w-full h-9 px-3 rounded-lg bg-[#2b2b2b] border border-[#00CAE0] text-white text-[13px] ring-1 ring-[#00CAE0]"
                />
              </div>
              <div className="space-y-1.5">
                <p className="text-[11px] text-[#b8b8b8]">Error</p>
                <input
                  type="text"
                  value="错误状态"
                  readOnly
                  className="w-full h-9 px-3 rounded-lg bg-[#2b2b2b] border border-[#ef4444] text-white text-[13px] ring-1 ring-[#ef4444]"
                />
                <p className="text-[11px] text-[#ef4444]">名称不能为空</p>
              </div>
              <div className="space-y-1.5">
                <p className="text-[11px] text-[#b8b8b8]">Disabled</p>
                <input
                  type="text"
                  value="不可编辑"
                  disabled
                  className="w-full h-9 px-3 rounded-lg bg-[#2b2b2b] border border-white/[0.10] text-white/40 text-[13px] cursor-not-allowed"
                />
              </div>
            </div>
          </div>
          ...
          {/* Card States */}
          <div>
            <p className="text-[12px] text-[#b8b8b8] mb-3 uppercase tracking-wider">项目卡片</p>
            <p className="text-[13px] text-[#a3a3a3] mb-4">以封面图为底，底部叠加项目名称和日期。图片区域保持纯净，不加状态标签或进度条。</p>
            <div className="flex flex-wrap gap-4">
              {/* Default */}
              <div className="group w-52 rounded-xl overflow-hidden border border-white/[0.10] bg-[#181818] cursor-pointer transition-shadow duration-200 hover:shadow-[rgba(255,255,255,0.12)_0px_0px_0px_1px] hover:border-white/10">
                ...
                <div className="relative p-3 -mt-10 bg-gradient-to-t from-[#141414] via-[#141414cc] to-transparent">
                  ...
                  <p className="text-[12px] text-[#a3a3a3] mt-0.5">2026-04-15</p>
                </div>
              </div>

              {/* Hover */}
              <div className="w-52 rounded-xl overflow-hidden border border-white/10 bg-[#181818] cursor-pointer shadow-[rgba(255,255,255,0.12)_0px_0px_0px_1px]">
                ...
                <div className="relative p-3 -mt-10 bg-gradient-to-t from-[#141414] via-[#141414cc] to-transparent">
                  ...
                  <p className="text-[12px] text-[#a3a3a3] mt-0.5">2026-04-10</p>
                </div>
              </div>

              {/* Selected */}
              <div className="w-52 rounded-xl overflow-hidden border border-[rgba(0,202,224,0.2)] bg-[#181818] cursor-pointer shadow-[rgba(0,202,224,0.15)_0px_0px_0px_1px]">
                ...
                <div className="relative p-3 -mt-10 bg-gradient-to-t from-[#141414] via-[#141414cc] to-transparent">
                  ...
                  <p className="text-[12px] text-[#a3a3a3] mt-0.5">2026-03-28</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div>
            <p className="text-[12px] text-[#b8b8b8] mb-3 uppercase tracking-wider">通用卡片交互态</p>
            <div className="flex flex-wrap gap-3">
              {/* Normal */}
              <div className="w-44 rounded-lg border border-[rgba(255,255,255,0.06)] bg-[#181818] p-3 transition-shadow hover:shadow-[rgba(255,255,255,0.12)_0px_0px_0px_1px] cursor-pointer">
                <p className="text-[13px] font-medium">Normal</p>
                <p className="text-[11px] text-[#b8b8b8] mt-1">悬停查看光环效果</p>
              </div>
              {/* Selected */}
              <div className="w-44 rounded-lg border border-[rgba(0,202,224,0.2)] bg-[#181818] p-3 shadow-[rgba(0,202,224,0.15)_0px_0px_0px_1px]">
                ...
                <p className="text-[11px] text-[#b8b8b8] mt-1">选中态 — 边框高亮</p>
              </div>
              {/* Dragging */}
              <div className="w-44 rounded-lg border border-[#00CAE0]/50 bg-[#181818] p-3 opacity-80 shadow-[0_8px_24px_rgba(0,0,0,0.4)] scale-[1.02]">
                <p className="text-[13px] font-medium">Dragging</p>
                <p className="text-[11px] text-[#b8b8b8] mt-1">拖拽中 — 微放大 + 阴影</p>
              </div>
              {/* Drop target */}
              <div className="w-44 rounded-lg border-2 border-dashed border-[#00CAE0]/40 bg-[#00CAE0]/5 p-3">
                ...
                <p className="text-[11px] text-[#b8b8b8] mt-1">放置目标 — 虚线指示</p>
              </div>
            </div>
          </div>
          ...
          {/* Toggle */}
          <div>
            <p className="text-[12px] text-[#b8b8b8] mb-3 uppercase tracking-wider">开关/切换</p>
            <div className="flex items-center gap-6">
              ...
              <span className="text-[13px] text-[#b8b8b8]">{toggled ? "已开启" : "已关闭"}</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="space-y-6">
        ...
        <div className="rounded-xl border border-[rgba(255,255,255,0.06)] bg-[#181818] p-6 space-y-6">
          <div>
            <p className="text-[13px] text-[#b8b8b8] mb-3">Primary — 白底黑字，页面唯一主操作</p>
            <div className="flex flex-wrap items-center gap-3">
              <button className="h-10 px-6 rounded-full bg-white text-black text-[13px] font-medium hover:bg-white/90 active:scale-[0.97] transition-all duration-100">
                创建项目
              </button>
          ...
          <div>
            <p className="text-[13px] text-[#b8b8b8] mb-3">Secondary — 强调色边框，次要相关操作</p>
            <div className="flex flex-wrap items-center gap-3">
          ...
          <div>
            <p className="text-[13px] text-[#b8b8b8] mb-3">Tertiary — 灰底，取消/返回等低权重</p>
            <div className="flex flex-wrap items-center gap-3">
              <button className="h-10 px-6 rounded-full bg-white/[0.10] text-white text-[13px] hover:bg-white/[0.1] active:scale-[0.97] transition-all duration-100">
                取消
              </button>
              <button className="h-10 px-6 rounded-full bg-white/[0.10] text-white text-[13px] hover:bg-white/[0.1] active:scale-[0.97] transition-all duration-100">
                返回
          ...
          <div>
            <p className="text-[13px] text-[#b8b8b8] mb-3">Ghost — 无底色</p>
            <div className="flex flex-wrap items-center gap-3">
              <button className="h-10 px-6 rounded-full text-[rgba(0,202,224,0.8)] text-[13px] hover:bg-white/[0.08] active:scale-[0.97] transition-all duration-100">
                了解更多 →
              </button>
              <button className="h-10 px-6 rounded-full text-[#b8b8b8] text-[13px] hover:text-white hover:bg-white/[0.08] active:scale-[0.97] transition-all duration-100">
                重置
              </button>
            </div>
          </div>
          <div>
            <p className="text-[13px] text-[#b8b8b8] mb-3">危险操作</p>
            <div className="flex flex-wrap items-center gap-3">
          ...
          <div>
            <p className="text-[13px] text-[#b8b8b8] mb-3">尺寸</p>
            <div className="flex flex-wrap items-center gap-3">
          ...
          <div>
            <p className="text-[13px] text-[#b8b8b8] mb-3">带图标</p>
            <div className="flex flex-wrap items-center gap-3">
      ...
      <section className="space-y-6">
        ...
        <div className="rounded-xl border border-[rgba(255,255,255,0.06)] bg-[#181818] p-6 space-y-5 max-w-lg">
          <div className="space-y-1.5">
            <label className="text-[13px] text-[#b8b8b8]">项目名称</label>
            <input
              type="text"
              placeholder="输入项目名称..."
              className="w-full h-10 px-4 rounded-lg bg-[#2b2b2b] border border-white/10 text-white text-[14px] placeholder:text-white/30 focus:outline-none focus:border-[#00CAE0] focus:ring-1 focus:ring-[#00CAE0] transition-colors"
            />
          </div>
          <div className="space-y-1.5">
            <label className="text-[13px] text-[#b8b8b8]">Prompt 编辑</label>
            <textarea
              placeholder="描述你想要生成的画面..."
              rows={3}
              className="w-full px-4 py-3 rounded-lg bg-[#2b2b2b] border border-white/10 text-white text-[14px] placeholder:text-white/30 focus:outline-none focus:border-[#00CAE0] focus:ring-1 focus:ring-[#00CAE0] transition-colors resize-none leading-[1.7]"
            />
          </div>
          <div className="space-y-1.5">
            <label className="text-[13px] text-[#b8b8b8]">搜索</label>
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="搜索项目..."
                className="w-full h-10 pl-9 pr-4 rounded-lg bg-[#2b2b2b] border border-white/10 text-white text-[14px] placeholder:text-white/30 focus:outline-none focus:border-[#00CAE0] focus:ring-1 focus:ring-[#00CAE0] transition-colors"
              />
            </div>
          </div>
        </div>
      ...
      <section className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {/* Project Card */}
          <div className="rounded-xl border border-[rgba(255,255,255,0.06)] bg-[#181818] overflow-hidden group hover:shadow-[rgba(255,255,255,0.12)_0px_0px_0px_1px] transition-shadow">
            <div className="aspect-video bg-[#1c1c1c] flex items-center justify-center">
              <p className="text-[13px] text-[#b8b8b8]">封面图</p>
            </div>
            <div className="p-4 space-y-2">
              ...
              <div className="flex items-center justify-between text-[12px] text-[#b8b8b8]">
                <span>2/4 集</span>
                <span>2 分钟前编辑</span>
              </div>
            </div>
          ...
          <div className="rounded-xl border border-[rgba(255,255,255,0.06)] bg-[#181818] overflow-hidden group hover:shadow-[rgba(255,255,255,0.12)_0px_0px_0px_1px] transition-shadow">
            <div className="aspect-square bg-[#1c1c1c] flex items-center justify-center">
              <div className="w-12 h-12 rounded-full bg-[#2b2b2b]" />
            </div>
            <div className="p-4 space-y-1">
              <h3 className="text-[15px] font-medium">秦羽</h3>
              <p className="text-[12px] text-[#b8b8b8]">角色 · 3 个变体</p>
            </div>
          </div>

          {/* Storyboard Card */}
          <div className="rounded-xl border border-[rgba(255,255,255,0.06)] bg-[#181818] p-4 space-y-3 group hover:shadow-[rgba(255,255,255,0.12)_0px_0px_0px_1px] transition-shadow">
      ...
      <section className="space-y-6">
        ...
        <div className="rounded-xl border border-[rgba(255,255,255,0.06)] bg-[#181818] p-4">
