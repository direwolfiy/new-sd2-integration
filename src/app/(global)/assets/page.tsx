  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
      {Array.from({ length: 10 }).map((_, i) => (
        <div key={i} className="rounded-lg border border-white/[0.12] bg-[#181818] overflow-hidden">
    ...
    <div className="max-w-6xl mx-auto">
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <button className="h-8 px-4 rounded-full bg-white/[0.10] text-white text-[13px] flex items-center gap-1.5 hover:bg-white/[0.1] transition-colors duration-200">
      ...
      {isLoading ? (
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
          {filtered.map((asset) => (
            <div
              key={asset.id}
              className="group rounded-lg border border-white/[0.12] bg-[#181818] overflow-hidden cursor-pointer transition-shadow duration-200 hover:shadow-[0_0_0_1px_rgba(255,255,255,0.12)]"
            >
              <div className="aspect-video bg-[#2b2b2b] flex items-center justify-center text-[#a3a3a3] text-[12px]">
                {asset.name}
              </div>
              <div className="p-3 space-y-1.5">
                ...
                <div className="flex items-center justify-between text-[11px] text-[#a3a3a3]">
                  <span className="px-1.5 py-0.5 rounded-full bg-white/[0.08]">
