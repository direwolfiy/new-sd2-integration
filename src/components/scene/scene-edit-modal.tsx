      ...
      <div className="w-[480px] rounded-xl border border-white/[0.14] bg-[#1c1c1c] shadow-[0_16px_48px_rgba(0,0,0,0.5)]">
        ...
        <div className="px-5 py-4 space-y-4">
          {isInfoModal ? (
            <>
              <div>
                <label className="block text-[12px] text-[#a3a3a3] mb-1.5">场景位置</label>
              ...
              <div>
                <label className="block text-[12px] text-[#a3a3a3] mb-1.5">氛围描述</label>
            ...
            <>
              <div className="flex gap-3">
                <div className="flex-1">
                  <label className="block text-[12px] text-[#a3a3a3] mb-1.5">状态名称</label>
              ...
              <div>
                <label className="block text-[12px] text-[#a3a3a3] mb-1.5">状态描述</label>
