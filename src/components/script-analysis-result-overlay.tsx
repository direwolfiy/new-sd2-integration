    ...
    <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/60 backdrop-blur-sm">
      <div className="w-[540px] max-h-[85vh] rounded-xl border border-white/[0.14] bg-[#1c1c1c] shadow-[0_16px_48px_rgba(0,0,0,0.5)] flex flex-col">
        ...
        <div className="flex items-center justify-between px-5 py-3 border-t border-white/[0.12]">
          <button
            onClick={onClose}
            className="h-9 px-4 rounded-full bg-white/[0.10] text-[13px] text-[#b8b8b8] flex items-center gap-1.5 hover:bg-white/[0.1] hover:text-white transition-colors duration-200"
          >
            稍后再说
          </button>
          <button
