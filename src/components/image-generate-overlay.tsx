            ...
            <div className="px-4 pt-4 pb-3 border-b border-white/[0.06] shrink-0">
              ...
              <div className="flex items-center gap-2 flex-wrap">
                ...
                <button
                  ...
                  className="w-20 h-20 rounded-lg border border-dashed border-white/[0.1] flex items-center justify-center text-[#666] hover:border-white/[0.2] hover:text-[#999] transition-colors duration-200"
                >
