...
import { getPlaybackBridge } from "../../openreel-bridges/playback-bridge";
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="flex items-center gap-1 px-2 py-1 bg-primary hover:bg-primary-hover text-white rounded text-[10px] font-medium transition-colors"
          >
            <Plus size={10} />
            Add
          </button>
